...
namespace WPXCronManagerLight\WPBones\Foundation;

use Closure;
use WPXCronManagerLight\WPBones\Container\Container;
use WPXCronManagerLight\WPBones\Contracts\Foundation\Plugin as PluginContract;
use WPXCronManagerLight\WPBones\Database\WordPressOption;
use WPXCronManagerLight\WPBones\Foundation\Http\Request;
use WPXCronManagerLight\WPBones\Foundation\Log\LogServiceProvider;
use WPXCronManagerLight\WPBones\Routing\AdminMenuProvider;
use WPXCronManagerLight\WPBones\Routing\AdminRouteProvider;
use WPXCronManagerLight\WPBones\Routing\API\RestProvider;
use WPXCronManagerLight\WPBones\Routing\Pages\PageProvider;
use WPXCronManagerLight\WPBones\Support\Str;
use WPXCronManagerLight\WPBones\Support\Traits\HasAttributes;
...
/**
 * @class   Plugin
 * @package WPXCronManagerLight\WPBones\Foundation
 *
...
class Plugin extends Container implements PluginContract
{
    ...
    public function boot(): Plugin
    {
        ...
        /*
             ...
             *
             ...
             Description = "WPXCronManagerLight is a WP Bones boilperate plugin"
             DomainPath = "localization"
             Name = "WPXCronManagerLight"
             Network = false
             PluginURI = "http://undolog.com"
             TextDomain = "wpx-cron-manager-light"
             Title = "WPXCronManagerLight"
             Version = "1.0.0"
             */
     ...
     *
     * @return \WPXCronManagerLight\WPBones\View\View
     */
    ...
    public function getCallableHook($routes)
    {
        ...
        if (isset($controller) && isset($method)) {
            return function () use ($controller, $method) {
                $className = "WPXCronManagerLight\\Http\\Controllers\\{$controller}";
